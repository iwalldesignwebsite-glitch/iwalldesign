  ...
  return (
    ...
    >
      <AnimatePresence initial={false}>
        <motion.div
          className="h-full w-[5px] absolute top-0 m-auto z-30 bg-gradient-to-b from-transparent  bg-white "
          style={{
            left: `${sliderXPercent}%`,
            top: "0",
            zIndex: 40,
        ...
        >
          {/* <div className="w-36 h-full [mask-image:radial-gradient(100px_at_left,white,transparent)] absolute top-1/2 -translate-y-1/2 left-0 bg-gradient-to-r from-[#32aa80] via-transparent to-transparent z-20 opacity-50" />
          <div className="w-10 h-1/2 [mask-image:radial-gradient(50px_at_left,white,transparent)] absolute top-1/2 -translate-y-1/2 left-0 bg-gradient-to-r from-[#16b1c2] via-transparent to-transparent z-10 opacity-100" /> */}
